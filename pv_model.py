...
if __name__ == "__main__":
    ...
    ax.set_title(f"PV Generation Profile - Xian {SIM_DATE} (total {PV_TOTAL_KW:.0f} kW installed, SOC min 40%)")
    ax.set_xticks(hours)
    ax.set_xticklabels([f'{h:02d}:00' for h in hours], rotation=45, ha='right')
    ax.legend()
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig("results/pv_profile_2500kW_min40soc.png", dpi=150)
    plt.show()
    print("\nPlot saved -> results/pv_profile_2500kW_min40soc.png")
